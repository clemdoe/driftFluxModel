...
def functionRecuperation(ImposedsousRelaxationFoctor, powerImposed):
    ## Parameters of the system
    # Equation resolution parameters
    eps = 10**(-3)
    N_iterations = 500
    sousRelaxFactor = ImposedsousRelaxationFoctor
    ...
    Height = 1.655 #m
    Q = powerImposed #300000000 #volumetric heat generation rate W/m3
    ...
    return U, P, H, epsilon, rho_l, rho_g, rho, x_th, zList, rho_g_RES, rho_l_RES, espilon_RES, x_th_RES, I, Hlsat, Hgsat, T, Tsat
