...
from classDFMV2 import DFMclass
import numpy as np
...
DFM1 = DFMclass(I_z, u_inlet, P_outlet, h_inlet, height, fuelRadius, cladRadius, waterGap, 'FVM', 'base', 'base', 'GEramp', 1500000000, 'sinusoidal')
